...
class GUI:
    ...
    def newGameThread(self):
        ...
        self.cleanState()  # resets GUI state.py
    ...
    def _update_control_panel(self, colony):
        """Reflect the game state.py in the play area."""
        self.update_food()
        ...
        # Save our new bee locations to our game state.py
...
class HttpHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def do_POST(self):
        path = self.path
        action = {
            '/ajax/fetch/state.py': gui.getState,
